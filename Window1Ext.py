...
class WindowExt(Ui_MainWindow):
    ...
    def total_value(self):
        try:
            ...
            total_value_calculated = (quantity_moisturiser * 180000) + (quantity_bdywash * 275600) + (quantity_cleanser * 98500) + (quantity_showergel * 254300) + (quantity_cream * 190600)
            self.lineEdit_moisturiser_2.setText(str(total_value_calculated))
        except:
            traceback.print_exc()
    def Reward(self):
        quantity_moisturiser = int(self.lineEdit_moisturiser.text())
        ...
        quantity_showergel = int(self.lineEdit_showergel.text())
        quantity_cream = int(self.lineEdit_cream.text())
        total_value_calculated = (quantity_moisturiser * 180000) + (quantity_bdywash * 275600) + (
                    quantity_cleanser * 98500) + (quantity_showergel * 254300) + (quantity_cream * 190600)
        ...
        if total_value_calculated >= 1000000:
            ...
            self.label_26.setText("Quý khách chưa đủ điều kiện nhận thưởng")
